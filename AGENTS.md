...
├── client/     # Next.js 16 app (AGENTS.md + skills inside)
...
- **pre-push:** `npm run lint` + `npm run typecheck` + `npm run test` + `npm run build`.
...
- Named exports only; logic in hooks/services; generics reused by specifics.
